...
module WaveformGenerator (
    ...
    output        _mux_cond_WaveformGenerator__I__local__I___io_output_T_4,
    _cond_pred_WaveformGenerator__I__local__I___T,
    _cond_pred_WaveformGenerator__I__local__I___T_1,
    _cond_pred_WaveformGenerator__I__local__I___T_2,
    _cond_pred_WaveformGenerator__I__local__I___T_3
);
  ...
  wire _GEN_4 = _cond_pred_WaveformGenerator__I__local__I___T_0 | _GEN_2 | _GEN_3;
  wire [3:0][7:0] _GEN_5 = {
  ...
  always @(posedge clock) begin
    if (reset) phaseAcc <= 16'h0;
    else phaseAcc <= phaseAcc + io_freqCtrl;
  end  // always @(posedge)
