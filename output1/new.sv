...
module WaveformGenerator (
    ...
    output        _mux_cond_topInst__local___io_output_T_4
);
  ...
  assign _mux_cond_topInst__local___io_output_T_4 =
    ~(io_waveType == 2'h0 | io_waveType == 2'h1 | io_waveType == 2'h2) & (&io_waveType)
    & _phase_T[15];
endmodule
