...
#ifndef VERILATED_VUART_RX_H_
#define VERILATED_VUART_RX_H_  // guard

#include "verilated.h"

class VUART_rx__Syms;
class VUART_rx___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VUART_rx VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VUART_rx___024root* const rootp;
    ...
    explicit VUART_rx(VerilatedContext* contextp, const char* name = "TOP");
    explicit VUART_rx(const char* name = "TOP");
