...
module UART_rx(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic [8:0]      _GEN_2 = clkCnterReg + 9'h1;
      ...
      _GEN_3 = stateReg == 2'h2;
      _GEN_4 = clkCnterReg < 9'h8A;
      _GEN_5 = _GEN_4 ? _GEN_2 : 9'h0;
      _GEN_6 = _GEN | _GEN_0;
      _GEN_7 = {{_GEN_5}, {_GEN_5}, {_GEN_1 ? _GEN_2 : 9'h0}, {9'h0}};
      clkCnterReg <= _GEN_7[stateReg];
      if (_GEN)
        bitCnterReg <= 4'h0;
      else if (_GEN_0 | ~_GEN_3 | _GEN_4) begin
      end
      else if (bitCnterReg[3])
        bitCnterReg <= 4'h0;
      else
        bitCnterReg <= bitCnterReg + 4'h1;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | (|(bitCnterReg[2:0]))) begin
      end
      else
        outDataReg_0 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h1) begin
      end
      else
        outDataReg_1 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h2) begin
      end
      else
        outDataReg_2 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h3) begin
      end
      else
        outDataReg_3 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h4) begin
      end
      else
        outDataReg_4 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h5) begin
      end
      else
        outDataReg_5 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h6) begin
      end
      else
        outDataReg_6 <= serialDataReg;
      if (_GEN_6 | ~_GEN_3 | _GEN_4 | bitCnterReg[2:0] != 3'h7) begin
      end
      else
        outDataReg_7 <= serialDataReg;
      outRxDoneReg <= ~_GEN & (~(_GEN_0 | _GEN_3) & (&stateReg) & ~_GEN_4 | outRxDoneReg);
      _GEN_8 =
        {{{2{_GEN_4}}},
