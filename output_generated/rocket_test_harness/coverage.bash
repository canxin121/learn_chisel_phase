...
DEFAULT_TOP_MODULE="TestHarness"
...
generate_step() {
    ...
    verilator --cc --trace ${module_name}.sv --exe obj_dir/sim_main.cpp --timing -Iobj_dir --top-module ${module_name} --Mdir obj_dir -I/home/canxin/git/rocket-chip/src/main/resources/vsrc -Wno-LATCH 
