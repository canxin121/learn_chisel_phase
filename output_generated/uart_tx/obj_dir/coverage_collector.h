...
private:
    ...
    VUART_tx* dut_ptr = nullptr; // Store DUT pointer for updates

public:
    // Mark methods defined outside the class declaration as inline
    inline CoverageCollector(); // Constructor
    inline void initialize(VUART_tx* top); // Initialization method
...
inline void CoverageCollector::initialize(VUART_tx* top) {
    if (!top) {
        throw std::runtime_error("Error: DUT pointer is null in CoverageCollector::initialize.");
    }
    dut_ptr = top; // Store the pointer
    std::cout << "CoverageCollector: Initializing coverage points for VUART_tx..." << std::endl;
...
// --- BEGIN POPULATING COVERAGE POINTS ---
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_1", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_1); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_1" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_2", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_2); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_2" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_3", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_3); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_3" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_4", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_4); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_4" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_5", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_5); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_5" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_6", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_6); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_6" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_7", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_7); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_7" << std::endl; }
        try { condition_points.emplace_back("_cond_pred_UART_tx__I__local__I___T_8", &top->_cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_8); } catch(...) { std::cerr << "Error adding cond point _cond_pred_UART_tx___05FI___05Flocal___05FI___05F_T_8" << std::endl; }
        // Register signal: _reg_signals_UART_tx__I__local__I__bitCnterReg (UInt<4>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__bitCnterReg", 4, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FbitCnterReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__clkCnterReg (UInt<8>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__clkCnterReg", 8, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FclkCnterReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__inDataReg (UInt<8>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__inDataReg", 8, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FinDataReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__outDataReg (UInt<1>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__outDataReg", 1, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FoutDataReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__outTxBusyReg (UInt<1>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__outTxBusyReg", 1, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FoutTxBusyReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__outTxDoneReg (UInt<1>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__outTxDoneReg", 1, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FoutTxDoneReg));
        // Register signal: _reg_signals_UART_tx__I__local__I__stateReg (UInt<2>)
        register_points.emplace_back("_reg_signals_UART_tx__I__local__I__stateReg", 2, reinterpret_cast<const void*>(&top->_reg_signals_UART_tx___05FI___05Flocal___05FI___05FstateReg));

// --- END POPULATING COVERAGE POINTS ---

    initialized = true;
    std::cout << "CoverageCollector: Initialization complete." << std::endl;
    std::cout << "  - Conditionally Predicates Registered: " << 9 << " (target: " << condition_points.size() << ")" << std::endl;
    std::cout << "  - Mux Conditions Registered:         " << 0 << " (target: " << mux_condition_points.size() << ")" << std::endl;
    std::cout << "  - Register Coverage Points Registered: " << 7 << " (target: " << register_points.size() << ")" << std::endl; // Note: regPointsCount is after flattening
    std::cout << "----------------------------------------" << std::endl;
}
