...
module UART_tx(
  ...
  wire       _cond_pred_prop_wire_UART_tx__I__local__I___T_5 = clkCnterReg < 8'h56;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      automatic logic [3:0][7:0] _GEN_0 =
        {{_cond_pred_prop_wire_UART_tx__I__local__I___T_5 ? clkCnterReg + 8'h1 : 8'h0},
         {_cond_pred_prop_wire_UART_tx__I__local__I___T_5 ? clkCnterReg + 8'h1 : 8'h0},
         {_cond_pred_prop_wire_UART_tx__I__local__I___T_5 ? clkCnterReg + 8'h1 : 8'h0},
         {8'h0}};
      automatic logic [3:0][1:0] _GEN_1 =
        {{{2{_cond_pred_prop_wire_UART_tx__I__local__I___T_5}}},
         {{1'h1, ~(_cond_pred_prop_wire_UART_tx__I__local__I___T_5 | ~(bitCnterReg[3]))}},
         {_cond_pred_prop_wire_UART_tx__I__local__I___T_5 ? 2'h1 : 2'h2},
         {{1'h0, io_i_tx_trig}}};
      ...
      if (_GEN) begin
        ...
        if (_cond_pred_prop_wire_UART_tx__I__local__I___T_2) begin
          if (~_cond_pred_prop_wire_UART_tx__I__local__I___T_5) begin
            ...
            outDataReg <= _outDataReg_T[0];
                 ...
                 | _cond_pred_prop_wire_UART_tx__I__local__I___T_5) begin
        end
        else begin
      ...
      outTxDoneReg <=
        ...
        & (~(_cond_pred_prop_wire_UART_tx__I__local__I___T_2
           ...
           & ~_cond_pred_prop_wire_UART_tx__I__local__I___T_5 | outTxDoneReg);
  ...
  assign _cond_pred_UART_tx__I__local__I___T = _GEN;
  ...
  assign _cond_pred_UART_tx__I__local__I___T_3 =
    _cond_pred_prop_wire_UART_tx__I__local__I___T_5;
