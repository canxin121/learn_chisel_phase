...
module MulDiv(
  ...
  always @(posedge clock) begin
    ...
    automatic logic [1:0] _decoded_T_2 = {decoded_invInputs[1], decoded_invInputs[2]};
    ...
    _GEN_0 = state == 3'h5;
    _GEN_1 = state == 3'h2;
    _GEN_2 = _GEN_1 & count == 7'h3F;
    _GEN_3 = state == 3'h3;
    _GEN_4 = count == 7'h40;
    _GEN_5 = _io_req_ready_output & io_req_valid;
    if (reset)
      state <= 3'h0;
    ...
    if (_GEN_5) begin
      ...
      automatic logic [64:0] _subtractor_T_1;
      _subtractor_T_1 = remainder[128:64] - divisor;
      if (_GEN_3) begin
        count <= count + 7'h1;
        remainder <=
          {1'h0,
