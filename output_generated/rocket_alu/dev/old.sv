...
module RocketALU(
  ...
  wire        slt =
    io_in1[63] == io_in2[63] ? _io_adder_out_T_3[63] : io_fn[1] ? io_in2[63] : io_in1[63];
  ...
  wire [63:0] shin =
    _shout_T | _shout_T_1 | io_fn == 5'h12 | _bext_mask_T
      ? {shin_hi, io_in1[31:0]}
      : {io_in1[0],
    ...
    io_fn == 5'hA | io_fn == 5'h0
      ...
      : {63'h0, io_fn > 5'hB & ~(io_fn[4]) & slt}
        ...
        | (_logic_T_8 | io_fn == 5'h7 | _logic_T_11 | io_fn == 5'h18
             ? io_in1 & in2_inv
             : 64'h0)
        | (_shout_T | _shout_T_1 | _bext_mask_T ? _shout_r_T_5[63:0] : 64'h0)
        | (io_fn == 5'h1
             ? {_shout_r_T_5[0],
                _shout_r_T_5[1],
                _shout_r_T_5[2],
