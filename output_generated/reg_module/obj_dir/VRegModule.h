...
#ifndef VERILATED_VREGMODULE_H_
#define VERILATED_VREGMODULE_H_  // guard

#include "verilated.h"

class VRegModule__Syms;
class VRegModule___024root;
class VerilatedVcdC;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VRegModule VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VRegModule___024root* const rootp;
    ...
    explicit VRegModule(VerilatedContext* contextp, const char* name = "TOP");
    explicit VRegModule(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~VRegModule();
  private:
    VL_UNCOPYABLE(VRegModule);  ///< Copying not allowed
