...
module SimpleFsm(
  ...
  wire       io_done_0 =
    ~(_cond_pred_SimpleFsm__I__local__I___T_2_0 | _GEN) & currentState == 2'h2;
  ...
  assign _cond_pred_SimpleFsm__I__local__I___T_2 =
    _cond_pred_SimpleFsm__I__local__I___T_2_0;
