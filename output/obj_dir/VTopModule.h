...
#ifndef VERILATED_VTOPMODULE_H_
#define VERILATED_VTOPMODULE_H_  // guard

#include "verilated.h"

class VTopModule__Syms;
class VTopModule___024root;

// This class is the main interface to the Verilated model
class alignas(VL_CACHE_LINE_BYTES) VTopModule VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    VTopModule___024root* const rootp;
    ...
    explicit VTopModule(VerilatedContext* contextp, const char* name = "TOP");
    explicit VTopModule(const char* name = "TOP");
